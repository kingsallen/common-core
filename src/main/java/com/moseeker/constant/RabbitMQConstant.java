...
public enum RabbitMQConstant {
    ...
    HR_OPERATOR_ALL_HISTORY("hr_opertor_all_record_queue"),
    HR_OPERATOR_ALL_HISTORY_ROUTEKEY("hr_opertor_all_record_routekey"),
    HR_OPERATOR_ALL_HISTORY_EXCHANGE("hr_opertor_all_record_exchange")
    ;
